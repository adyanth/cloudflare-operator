...
# cfargotunnel.com/cloudflare-operator-bundle:$VERSION and cfargotunnel.com/cloudflare-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= adyanth/cloudflare-operator
